                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <li><a href="ahome.php"><i class="fa fa-home"></i> Home <span class="fa fa-chevron"></span></a>
                            ...
                            <li><a href='courselist.php'><i class="fa fa-file"></i> Courses list <span
                            ...
                            <li><a href='transactionlist.php'><i class="fa fa-user"></i> Admins list <span class="fa fa-chevron"></span></a>

                            </li>
                            <li><a href='transactionlist.php'><i class="fa fa-child"></i> Students list <span class="fa fa-chevron"></span></a>
                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <?php
                                $res=mysqli_query($link,"select * from student_register");
                                ...
                                while($row=mysqli_fetch_array($res))
                                {
                                    ...
                                    if("$row[approval]"==0){
                                        echo "<td>"; ?> <a href="approve.php?id=<?php echo $row["username"]; ?>">Approve</a> <?php echo "</td>";
                                    }
                                    else{
                                        echo "<td>"; ?> <a href="notapprove.php?id=<?php echo $row["username"]; ?>">Not Approve</a> <?php echo "</td>";
                                    }
                                    echo "</tr>";
                                }
                                echo "</table>";
