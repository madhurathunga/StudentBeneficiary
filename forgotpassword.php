...
{ 
    $res1=mysqli_query($link,"select * from student_register where email='$_POST[email]'");
    $count1=mysqli_num_rows($res1);
    if($count1>0){
        $row1=mysqli_fetch_array($res1);
        $res7=mysqli_query($link,"select * from student where username='$row1[username]'");
        $count7 = mysqli_num_rows($res7);
        mysqli_query($link,"update student_register set password='$pass' where email='$_POST[email]'");
        mysqli_query($link,"update student_register set confirmpasswd='$pass' where email='$_POST[email]'");
        if($count7>0){
