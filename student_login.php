...
<head>
    ...
    <title>Student Login Form | SBS </title>
...
if(isset($_POST['submit1'])){
    $count1=0;
    $res1=mysqli_query($link,"select *from student_register where (username='$_POST[username]') or (email='$_POST[username]')");
    ...
    if($count1==1){
            ...
            elseif($row["approval"]==0){
                ...
                $res2=mysqli_query($link,"select * from student where username='$row[username]'");
