                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content" id="content">
                                ...
                                $imp=mysqli_query($link,"select * from student where usn in (select usn from transaction where (bookid='$id' and role='buy'))");
                                $im=mysqli_fetch_array($imp);
                                $count1=mysqli_num_rows($imp);
                                $a1=mysqli_query($link,"select * from student_register where username='$_SESSION[username]'");
                                $a2=mysqli_fetch_array($a1);
                                
                                $b1=mysqli_query($link,"select * from student where username='$_SESSION[username]'");
                                ...
                                $res13=mysqli_query($link,"select * from transaction where (bookid='$id' and role='buy')");
                                ...
                                mysqli_query($link,"insert into notification (susername,busername,fname,lname,phoneno,email,bookid,date,message) values ('$_SESSION[username]','$im[username]','$b2[fname]','$b2[lname]','$a2[phoneno]','$a2[email]',$id,curdate(),'Payment Successful')");
                                ...
                                echo "<tr>";
                                echo "<th>";
                                echo "<h2>"."Buyer Name          - ".$row17["fname"]." ".$row17["lname"]."</h2>";
                                echo "</th>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<th>";
                                echo "<h2>"."USN of Buyer        - ".$row17["usn"]."</h2>";
                                echo "</th>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<th>";
                                echo "<h2>"."Email id of buyer   -"?> <a href="mailto: <?php echo $email?>"style="color:black"><?php echo $row888["email"] ?></a><?php "</h2>";
                                echo "</th>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<th>";
                                echo "<h2>"."Phone no.of buyer   - ".$row888["phoneno"]."</h2>";
                                echo "</th>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<th>";
                                echo "<h2>"."Received money      - ".$row3["sellingprice"]."</h2>";
                                echo "</th>";
                                echo "</tr>";
                                echo "<tr>";
                                echo "<th>";
