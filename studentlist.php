                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <li><a href='adminlist.php'><i class="fa fa-user"></i> Admins list <span class="fa fa-chevron"></span></a>
                            ...
                            <li><a href='booklist.php'><i class="fa fa-book"></i> Books list <span class="fa fa-chevron"></span></a>
            ...
            <div class="">
                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>All Student's information</h2>
                            ...
                            <div class="x_content">
                                ...
                                echo "<th>"; echo "House name"; echo "</th>";
                                echo "<th>"; echo "Street name"; echo "</th>";
                                ...
                                while($row=mysqli_fetch_array($res))
                                {
                                    ...
                                    echo "<td>"; echo $row["housename"]; echo "</td>";
