                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <?php
                                $res4=mysqli_query($link,"select * from student where username='$_GET[id]'");
                                $row4=mysqli_fetch_array($res4);
                                $res3=mysqli_query($link,"select * from student_register where username='$_GET[id]'");
                                ...
                                echo "</tr>";                           
                                echo "<td>";
                                echo "<b>".$row4["fname"]." ".$row4["lname"]."</b>";
                                echo "</td>";
                                echo "<td>";
                                ?>
                                 <a href="mailto: <?php echo $email?>"style="color:black"><?php echo $email ?></a><?php
                                echo "</td>";
                                echo "<td>";
                                echo "<b>".$row3["phoneno"]."</b>";
                                echo "</td>";
                                echo "</tr>";
                                echo "</table>";
                                ?>
