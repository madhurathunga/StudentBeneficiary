                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <?php
                                $res22=mysqli_query($link,"select * from notification where ((busername='$_SESSION[username]') AND (read1=0 AND message='Payment Successful'))");
                                $count2=mysqli_num_rows($res22);
                                $res4=mysqli_query($link,"select * from notification where ((susername='$_SESSION[username]') AND (read1=0 AND message='Buy book'))");
                                ...
                                {
                                    $res3=mysqli_query($link,"Select bookname from books where bookid=$row4[bookid]");
                                    $row3=mysqli_fetch_array($res3);
                                     echo "<td>";
                                    echo "<b>"."$row4[fname] $row4[lname] has requested to buy $row3[bookname] on $row4[date]"."</b>";
                                    echo "</td>";
                                    
                                    echo "<td>"; ?> <a href="contact_student.php?id=<?php echo $row4['busername']; ?>">Contact details</a> <?php echo "</td>";
                                    echo "<td>"; ?> <a href="markasread.php?id=<?php echo $row4['id']; ?>">View</a> <?php echo "</td>";
                                    echo "</tr>";
                                        echo "<tr>";
                                ...
                                elseif($count==0&&$count2!=0){
                                    ...
                                    {
                                        $res3=mysqli_query($link,"Select bookname from books where bookid=$row22[bookid]");
                                        $row3=mysqli_fetch_array($res3);
                                         echo "<td>";
                                        echo "<b>"."$row22[fname] $row22[lname] says that payment was successful for $row3[bookname] on $row22[date]"."</b>";
                                        echo "</td>";
                                        
                                        echo "<td>"; ?> <a href="contact_student.php?id=<?php echo $row22['susername']; ?>">Contact details</a> <?php echo "</td>";
                                        echo "<td>"; ?> <a href="markasread.php?id=<?php echo $row22['id']; ?>">View</a> <?php echo "</td>";
                                        echo "</tr>";
                                            echo "<tr>";
