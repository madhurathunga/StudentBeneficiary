...
<head>
    ...
    <title>Admin Registration Form | SBS </title>
...
<body class="login" style="margin-top: -20px;">
    ...
    <div class="login_wrapper">
            ...
            <div class="separator">
                <p class="change_link">Already regsitered admin?
            ...
            {
                $res40=mysqli_query($link,"select *from admin_register where username='$_POST[username]'");
                $count40=mysqli_num_rows($res40);
                $res41=mysqli_query($link,"select *from admin_register where email='$_POST[email]'");
                ...
                elseif($_POST['password']!=$_POST['confirmpasswd']){
                    ...
                    mysqli_query($link,"insert into admin_register (username,email,phoneno,password,confirmpasswd) values ('$_POST[username]','$_POST[email]','$_POST[contact]','$_POST[password]','$_POST[confirmpasswd]')");
                    ?>
                    <script type="text/javascript">
