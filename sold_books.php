                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                $res3=mysqli_query($link,"select * from books where (bookid in (select bookid from transaction where (usn='$row4[usn]') and (role='sell' and approval=1)))");
                                ...
                                while($row3=mysqli_fetch_array($res3))
                                {
                                    ...
                                    echo "</td>";
                                    $res300=mysqli_query($link,"select * from transaction where (bookid='$row3[bookid]') and role='sell'");
                                    
                                    echo "<td>"; ?> <a href="seller.php?id=<?php echo $row3['bookid']; ?>">View</a> <?php echo "</td>";
