                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                $res3=mysqli_query($link,"select * from transaction where (usn='$row4[usn]') and (approval=1)");
                                echo "<table class='table table-bordered'>";
                                echo "<tr>";
                                echo "<th>";
                                echo "<b>"."Date of transaction"."</b>";
                                echo "</th>";
                                echo "<th>";
                                echo "<b>"."Book name"."</b>";
                                echo "</th>";
                                ...
                                while($row3=mysqli_fetch_array($res3))
                                {
                                    $i=$i+1;
                                    echo "<td>";
                                    echo "<b>".$row3["dateofbookadded"]."</b>";
                                    echo "</td>";
                                    $res400=mysqli_query($link,"select * from books where bookid='$row3[bookid]'");
                                    $row400=mysqli_fetch_array($res400);
                                    echo "<td>";
                                    echo "<b>".$row400["bookname"]."</b>";
                                    echo "</td>";
                                    echo "<td>";
                                    echo "<b>".$row3["role"]."</b>";
                                    echo "</td>";
                                    if($row3["role"]=='sell'){
                                        echo "<td>"; ?> <a href="seller.php?id=<?php echo $row3['bookid']; ?>">Yes</a> <?php echo "</td>";
                                    }
                                    else{
                                        echo "<td>"; ?> <a href="buyer.php?id=<?php echo $row3['bookid']; ?>">Yes</a> <?php echo "</td>";
                                    }
                                    echo "</tr>";
                                    if($i==1)
                                    {
